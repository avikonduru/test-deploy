  ...
  return (
    <div>
      <Row style={{ marginBottom: 20 }}>
        <Col span={24}>
          <Title level={4}>ACH or US Domestic Wire</Title>
          <Text type="secondary">
            This is for payments only to the companies and individuals
            located in the US
          </Text>
        </Col>
      </Row>
      ...
      <Row style={{ marginBottom: 20 }}>
        <Col span={24}>
          ...
          >
            <Form.Item label="Transfer Type" name="transferValue">
              <Radio.Group>
                <Radio.Button value="ach">ACH Transfer</Radio.Button>
                <Radio.Button value="domestic_wire">
